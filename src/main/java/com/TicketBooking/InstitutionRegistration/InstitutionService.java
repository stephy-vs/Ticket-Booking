...
public class InstitutionService {
    ...
    public InstitutionDTO eduDetails(Institution institution) {
        try {
            ...
            return new InstitutionDTO(institution.getId(), institution1.getName(),institution1.getPhoneNumber(),
                    institution.getTeachers(), institution1.getStudent(),institution1.getBookDate(),
                    institution1.getTotal());
